    ...
    <section className={css.wrapper}>
        ...
        className={`paddings yPaddings innerWidth flexCenter ${css.container}`}>
            ...
            <div className={css.leftSide}>
                {
                    projectExperience.map((exp, i)=> {
                        return <motion.div variants = {fadeIn("right", "tween", (i+1)*0.2, 1)} className={css.exp} key={i}>
                            ...
                            <div>
                                <span>{exp.name}</span>
                                <span className='secondaryText'>{exp.projects} Projetos</span>
                            </div>
                        </motion.div>
                    })
                }
            ...
            className={css.rightSide}>
                ...
                <span className='primaryText'>Quem e João Gabriel? </span>
                ...
                <div className={`flexCenter ${css.stats}`}>
                    <div className={`flexCenter ${css.stat}`}>
                        ...
                        <span className='secondaryText'>Projeto concluído</span>
                    </div>
                    <div className={`flexCenter ${css.stat}`}>
                        <span className='primaryText'>7+</span>
